...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'cd98ba341814737307c01aeba3c7e03e',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Self service app users will claim calendar time <app@flatlogic.app>',
  ...
  project_uuid: 'ba420914-8384-4f4a-b12d-a0091512e8b1',
  flHost:
