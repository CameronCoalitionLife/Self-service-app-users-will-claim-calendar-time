...
module.exports = class LocationsDBApi {
  static async create(data, options) {
    ...
    await locations.setOrganization(currentUser.organization.id || null, {
      transaction,
    });
  ...
  static async update(id, data, options) {
    ...
    await locations.setOrganization(
  ...
  static async findBy(where, options) {
    ...
    output.time_slots_location = await locations.getTime_slots_location({
      transaction,
    });

    output.organization = await locations.getOrganization({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    if (filter) {
      ...
      if (filter.address) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('locations', 'address', filter.address),
        };
      }
