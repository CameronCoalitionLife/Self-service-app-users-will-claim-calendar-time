...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.locations_organization =
      await organizations.getLocations_organization({
        transaction,
      });
    ...
    output.time_slots_organization =
      await organizations.getTime_slots_organization({
        transaction,
      });
