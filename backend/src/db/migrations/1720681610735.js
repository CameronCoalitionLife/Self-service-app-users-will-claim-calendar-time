module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('time_slots', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('locations', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('time_slots', 'booked_byId', {
        transaction,
      });

      await queryInterface.removeColumn('time_slots', 'locationId', {
        transaction,
      });

      await queryInterface.removeColumn('time_slots', 'end_time', {
        transaction,
      });

      await queryInterface.removeColumn('time_slots', 'start_time', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('bookings', 'occurrences', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('bookings', 'recurrence', {
        transaction,
      });

      await queryInterface.removeColumn('bookings', 'time_slotId', {
        transaction,
      });
      ...
      await queryInterface.dropTable('time_slots', { transaction });
