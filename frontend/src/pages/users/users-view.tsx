    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Time_slots BookedBy</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.time_slots_booked_by &&
                      Array.isArray(users.time_slots_booked_by) &&
                      users.time_slots_booked_by.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.time_slots_booked_by?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
