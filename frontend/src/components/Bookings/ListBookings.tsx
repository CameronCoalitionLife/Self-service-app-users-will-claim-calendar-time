            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>TimeSlot</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.time_slotsOneListFormatter(item.time_slot)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>Recurrence</p>
                    <p className={'line-clamp-2'}>{item.recurrence}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.occurrences}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
