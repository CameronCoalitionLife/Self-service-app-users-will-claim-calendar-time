...
const ListTime_slots = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_TIME_SLOTS');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>BookedBy</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.usersOneListFormatter(item.booked_by)}
                    </p>
                  </div>
                </div>
                <ListActionsPopover
